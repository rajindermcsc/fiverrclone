...
public class POSTLastVisitedGigs {
    @SerializedName("code")
    @Expose
    ...
    public class Data {
        ...
        @SerializedName("visited_details")
        @Expose
        private List<Visited_detail> visited_details = null;
        ...
        public List<Visited_detail> getVisited_details() {
            return visited_details;
        }

        public void setVisited_details(List<Visited_detail> visited_details) {
            this.visited_details = visited_details;
        }

    }

    public class Visited_detail {
