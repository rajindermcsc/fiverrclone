...
public class POSTFavGigs {
    ...
    public class Data {
        ...
        @Expose
        private List<Favourite_detail> favourite_details = null;
        ...
        public List<Favourite_detail> getFavourite_details() {
            return favourite_details;
        }

        public void setFavourite_details(List<Favourite_detail> favourite_details) {
            this.favourite_details = favourite_details;
        }
