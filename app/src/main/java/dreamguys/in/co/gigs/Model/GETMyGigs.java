...
public class GETMyGigs {
    ...
    public class Data {
        ...
        @Expose
        private List<Gigs_detail> gigs_details = null;
        ...
        public List<Gigs_detail> getGigs_details() {
            return gigs_details;
        }

        public void setGigs_details(List<Gigs_detail> gigs_details) {
