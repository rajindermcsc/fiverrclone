...
public class GETAllGigs {
    ...
    public class Data {
        ...
        @Expose
        private List<Category_detail> category_details = null;
        ...
        public List<Category_detail> getCategory_details() {
            return category_details;
        }

        public void setCategory_details(List<Category_detail> category_details) {
